    ...
    void * const user_ctx)
{
    ...
    struct blobmsg_policy const aliases_policy[ALIASES_MAX__] = {
        [ALIASES] =
        { .name = _led_alias_aliases, .type = BLOBMSG_TYPE_ARRAY }
    };
    struct blob_attr * fields[ALIASES_MAX__];
