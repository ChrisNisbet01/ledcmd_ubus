...
populate_lock_led_result(
    struct led_lock_result_st * const result, struct blob_attr * const response)
{
    enum
    {
        SUCCESS,
    ...
    struct blobmsg_policy const get_lock_policy[LOCK_MAX__] =
    {
        [SUCCESS] =
...
lock_led_response_handler(
    struct ubus_request * const req, int const type, struct blob_attr * const response)
{
    UNUSED_ARG(type);
    ...
    struct ledcmd_names_ctx_st * const ctx)
{
    ...
    blobmsg_for_each_attr(cur, array_blob, rem)
    {
        ...
        struct blob_attr * fields[GET_NAME_MAX__];
    ...
    struct blob_attr * const response)
{
    ...
    struct blob_attr * fields[NAMES_MAX__];
    ...
    struct ubus_request * req, int type, struct blob_attr * response)
{
    ...
    struct blob_attr * fields[STATES_MAX__];
